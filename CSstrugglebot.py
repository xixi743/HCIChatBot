...
class CSstrugglebot(ChatBot):
    """A simple chatbot that directs struggling CS students to various tools for CS success."""
    ...
    def respond_from_failing(self, message, tags):
    ...
    def finish_confused(self):
        return "Sorry, I'm just a simple bot that can't understand much. You can ask me about how to do better in CS, though!"
